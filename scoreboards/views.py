...
def team_leaderboard_view(request):
    ...
    # Eğer kullanıcı takım tabanlı bir gruba ait değilse veya takımı yoksa, grup liderlik panosuna yönlendirme
    if not group or not group.is_team_based or not user.team:
